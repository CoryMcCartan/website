...
<h2>NOTE</h2>
<p>
This model relies on GDP forecasts made by the New York branch of the Federal
Reserve. On Friday, April 17, the Fed branch revised its estimate of
second-quarter GDP growth sharply downwards, causing the model to adjust its
structural forecast in favor of Joe Biden, which greatly increased his estimated
chances of winning the election.
</p>
<p>
The pandemic and its economic fallout have caused a lot to change very quickly.
As more economic and polling data arrive, the model's estimates should
stabilize.
</p>
<div style="color: #877; font-size: 0.85rem; text-align: right;">
5:21 p.m., April 17, 2020
</div>
</div>
...
<ul>
<li>Second-quarter annualized GDP growth is estimated by the New York branch of
the Federal Reserve at <b id="q2_gdp"></b>.</li>
