...
<span class="leadin">THE ROUGHLY SEVEN AND A HALF MILLION PRIVATE-SECTOR
...
#oeozgtruuq .gt_column_spanner_outer {
  color: black;
  background-color: transparent;
  font-size: 100%;
  font-weight: normal;
...
#oeozgtruuq .gt_empty_group_heading {
  padding: 0.5px;
  color: black;
  background-color: transparent;
  font-size: 100%;
